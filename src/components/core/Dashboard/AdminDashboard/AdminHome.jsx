...
const AdminHome = () => {
  ...
  const leadsPerPage = 5; // Change this to your desired number of leads per page
  ...
  if (loading) {
    return <div className=" text-xl text-white">Loading leads and vendors...</div>;
  }
  ...
  return (
    <div className=" px-8">
      <div className="flex items-center justify-center space-x-4 mb-6">
        ...
        <button
          ...
          className={`py-2 px-4 rounded ${
            activeTab === "leads" ? " bg-green-400 text-white" : " bg-blue-400 text-white"
          }`}
        >
          Leads
        </button>
        <button
          ...
          className={`py-2 px-4 rounded ${
            activeTab === "vendors" ? " bg-green-400 text-white" : " bg-blue-400 text-white"
          }`}
        >
          Vendors
        </button>
      ...
      {activeTab === "leads" && (
        <>
          <h1 className="text-3xl font-bold mb-6 text-white text-center">All Leads</h1>
          {
            leads.length === 0 ? (<div className="text-2xl text-white text-center">No Leads Found</div>) :
            (
          ...
          <div className="flex justify-between gap-2 mt-6">
            <button
              ...
              className={`py-2 px-4 rounded ${currentPage === 1 ? "bg-gray-400" : "bg-blue-500"} text-white`}
            >
              Previous
            </button>
            ...
            <button
              ...
              className={`py-2 px-4 rounded ${currentPage === totalPages ? "bg-gray-400" : "bg-blue-500"} text-white`}
            >
              Next
            </button>
          </div>
      ...
      {activeTab === "vendors" && (
        <>
          <h1 className="text-3xl font-bold mb-6 text-white text-center">All Vendors</h1>
          {vendors.length === 0 ? (<div className="text-2xl text-white text-center">No Vendors Found</div>) : 
          (
